...
option1 = BooleanVar()
Checkbutton(passwordStructure, variable=option1, bg="#222930").grid(row=4, column=1, sticky="news")
...
option2 = BooleanVar()
Checkbutton(passwordStructure, variable=option2, bg="#222930").grid(row=5, column=1, sticky="news")
...
option3 = BooleanVar()
Checkbutton(passwordStructure, variable=option3, bg="#222930").grid(row=6, column=1, sticky="news")
...
option4 = BooleanVar()
Checkbutton(passwordStructure, variable=option4, bg="#222930").grid(row=7, column=1, sticky="news")
...
password = Listbox(password_manager,height= 15, width= 41, font="fixedsys 10", fg="black")
