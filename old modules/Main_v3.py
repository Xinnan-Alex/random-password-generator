...
listboxCategory = Listbox(codeoption, height=13, width=20, font="fixedsys 13", fg="black")
...
listboxSocialMedia = Listbox(socialmedia, height=17, width=20, font="fixedsys 13", fg="black")
...
listboxWork = Listbox(work,height=15, width=20, font="fixedsys 13", fg="black")
...
def category_qrcode_onselect(option):
    ...
    if index == 0:
        selectedcategory_qrcode = 0
        raise_frame(socialmedia)
    if index == 1:
        selectedcategory_qrcode = 1
        raise_frame(entertainment)
    if index == 2:
        selectedcategory_qrcode = 2
        raise_frame(work)
    if index == 3:
        selectedcategory_qrcode = 3
        raise_frame(study)
    if index == 4:
        selectedcategory_qrcode = 4
        raise_frame(customise)
    print(selectedcategory_qrcode)

def socialmedia_onselect(option):
    w = option.widget
    global selectedcategory_socialmedia
    index = (w.curselection()[0])
    if index == 0:
        selectedcategory_socialmedia = 'Facebook'
    if index == 1:
        selectedcategory_socialmedia = 'Instagram'
    if index == 2:
        selectedcategory_socialmedia = 'WeChat'
    if index == 3:
        selectedcategory_socialmedia = 'Line'
    if index == 4:
        selectedcategory_socialmedia = 'Snapchat'
    if index == 5:
        selectedcategory_socialmedia = 'Google'
    if index == 6:
        selectedcategory_socialmedia = 'Telegram'
    if index == 7:
        selectedcategory_socialmedia = 'LinkedIn'
    print(selectedcategory_socialmedia)
...
listboxSocialMedia.bind('<<ListboxSelect>>', socialmedia_onselect)
...
var1 = IntVar()
Checkbutton(codePassword, variable=var1, bg="#222930").grid(row=4, column=1, sticky=W)
lblalpha = Label(codePassword, text="Alphabets lowercase(a-z)", bg="#222930", fg="#E9E9E9", font="verdana 10")
lblalpha.grid(row=4, column=0, padx=200, pady=10, sticky=W)

var2 = IntVar()
Checkbutton(codePassword, variable=var2, bg="#222930").grid(row=5, column=1, sticky=W)
lblAlpha = Label(codePassword, text="Alphabets uppercase(a-z)", bg="#222930", fg="#E9E9E9", font="verdana 10")
lblAlpha.grid(row=5, column=0,padx=200, pady=10, sticky=W)

var3 = IntVar()
Checkbutton(codePassword, variable=var3, bg="#222930").grid(row=6, column=1, sticky=W)
lblDigits = Label(codePassword, text="Digits", font="verdana 10", bg="#222930", fg="#E9E9E9")
lblDigits.grid(row=6, column=0, padx=200, pady=10, sticky=W)

var4 = IntVar()
Checkbutton(codePassword, variable=var4, bg="#222930").grid(row=7, column=1, sticky=W)
