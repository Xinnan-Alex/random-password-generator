...
def Proceed_BARCODE():
	...
	if M3_OoiKherNing_1191100876_MODIFIED.duplicatePNG_checker(BARcode_PNG) == True:
		...
		M3_OoiKherNing_1191100876_MODIFIED.barcode(barcode_notes,BARcode_PNG)
...
btnBack.grid(row=11, column=0, columnspan=2 , padx= 400, pady=100, sticky="news")
...
btnBack = Button(notes, text= "BACK", font="courier 10 bold", fg="#E9E9E9", bg="#4EB1BA", command=lambda:raise_frame(code))
...
lbldata.grid(row=1, column=0, columnspan=3, padx=200, pady=20, sticky="news")
...
lbldata.grid(row=2, column=0, columnspan=3, padx=200, pady=20, sticky="news")
...
lblPNG_name.grid(row=9, column=0, padx=90, pady=15, sticky= E)
...
btnBack = Button(notesbarcode, text= "BACK", font="courier 10 bold", fg="#E9E9E9", bg="#4EB1BA", command=lambda:raise_frame(code))
btnBack.grid(row=10, column=1, padx= 50,pady=10, sticky=W)
